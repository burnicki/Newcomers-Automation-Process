...
class MsGraphAuthenticator():
    ...
    def generate_access_token_delegated(self):
        ...
        if os.path.exists('/Users/maciejcichocki/Documents/GitHub/newcomers_process_automation/access_token.json'):
            with open('/Users/maciejcichocki/Documents/GitHub/newcomers_process_automation/access_token.json', 'r') as token_file:
        ...
        with open('/Users/maciejcichocki/Documents/GitHub/newcomers_process_automation/access_token.json', 'w') as token_file:
...
def add_sharepoint_email_tracking_record(site_id, email_tracking_list_id, headers, employee_data, mail_sender, shippment_data, office_pick_up, equipment_data):
    ...
    mail_sender.send_mail("off@lingarogroup.com", "Ordering a shipment courier", content, "2137", headers)
    if office_pick_up:
...
def check_email_tracker_list(employee_data, site_id, email_tracking_list_id, headers, mail_sender, shippment_data, office_pick_up, equipment_data):
    ...
    for employee in employee_data:
        ...
        if start_date - timedelta(days=2) <= current_date <= start_date:
            print("siema")
...
if __name__ == "__main__":
    load_dotenv("/Users/maciejcichocki/Documents/GitHub/newcomers_process_automation/token.env")
    ...
    sheet_counter = 51    # dodanie funkcji automatycznego zmieniania sheet w excelu na podstawie daty 
    main(
